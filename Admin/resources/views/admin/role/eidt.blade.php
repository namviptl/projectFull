...
@section('title')
  <title>Chỉnh sửa chức năng</title>
@endsection
          ...
          <form action="{{ route('roles.update', ['id' => $role->id]) }}" method="post" style="width: 100%;">
            <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="name" value="{{$role->name}}" placeholder="Nhập tên vai trò...">
                </div>
                <div class="form-group">
            ...
            <div class="col-md-12">
              ...
              <div class="card border-secondary mb-3 md-12">
                ...
                <div class="card-body text-secondary">
                  <label>
                      <input type="checkbox" {{$permissionChecked->contains('id', $permissionChildrentItem->id) ? 'checked' : ''}} name="permission_id[]" value="{{$permissionChildrentItem->id}}" class="checkbox-childrent">
            ...
            <div class="col-md-6">
              <button type="submit" class="btn btn-primary mb-2 btn-edit">Chỉnh sửa</button>
            </div>
          </form> 
        </div>
      </div>
